...
export default function Receivables({ initialSales, payments }: { initialSales: CreditSale[]; payments: CreditPayment[] }) {
  ...
  return <main className={styles.shell}>
    <header className={styles.header}><div><span>CUENTAS POR COBRAR</span><h1>Créditos</h1><p>Controla ventas pendientes y registra cuando llegue el pago.</p></div><nav><a href="/admin/pos">← Regresar al POS</a><a href="/admin/pos/facturas">Facturas pendientes</a><a href="/admin/pos/corte">Corte del día</a><button onClick={() => window.location.reload()}>Actualizar</button></nav></header>
